...
const faqs: { q: string; a: string }[] = [
  {
    ...
    a: "The cloud pipeline runs all seven layers (transcription, scoring, reframing, captioning) on optimized GPU clusters in parallel, not one stage at a time. Intelligent caching means repeat runs on the same footage are even faster. Median target from upload to first finished clip: under 90 seconds, versus 10 to 20 minutes for OpusClip or Klap.",
  },
  {
    q: "How accurate is the clip selection?",
    a: "Every candidate moment is scored out of 100 by the virality engine using audio analysis (laughter spikes, dramatic pauses), transcript semantics, and platform trend data. Each clip ships with concrete improvement tips, so nothing is a black box. When it does miss, one chat message like “cut in two seconds later” fixes it.",
  },
  {
  ...
  },
  {
    ...
    a: "Pro plans export a timeline XML alongside every clip, with cuts, reframe keyframes, and caption layers intact. Open it in Premiere, Resolve, or Final Cut and keep working on your own timeline. The AI does the first 95%; you keep full control of the last 5%.",
  },
  {
  ...
  },
  {
    ...
    a: "Studio runs Whisper AI and the virality engine entirely in your browser, so your video never leaves your device. Give it a talking video (15 minutes or less works best) and it cuts 9:16 captioned clips, each scored out of 100. The 90-second cloud pipeline that chews through hour-long podcasts is coming next.",
  },
  {
